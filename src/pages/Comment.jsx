...
export default function Comment() {
  ...
  return (
    <div>
      ...
      {comments.length ? (<Pagination itemsCount={commentsCount} numberOfitemInEveryPage={limit} reseter={paginatorChangerFlag} setOffset={setOffset} paginationHandler={paginationHandler} />) : ''}
