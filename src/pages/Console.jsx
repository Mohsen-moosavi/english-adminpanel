                                    ...
                                    <div className="flex items-center justify-between mt-5">
                                        ...
                                        <div className="flex flex-col items-end">
                                            {course.offs && course.offs.length && course.offs[0].public ? (
                                                ...
                                                <>
                                                    <span className="text-end text-custom-dark-blue font-bold leading-[16px] mt-2">{Number(course.price) === 0 ? 'رایگان' : Number(course.price).toLocaleString()}<br /><span
                                                        className="font-medium text-gray-400">{Number(course.price) === 0 ? '' : "تومان"}</span></span>
                                                </>
                                            )}
